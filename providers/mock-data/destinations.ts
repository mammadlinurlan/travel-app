...
export const DESTINATIONS: Record<string, DestinationProfile> = {
  ...
  AYT: {
    ...
    country: "Turkey",
    image:
      "https://images.unsplash.com/photo-1601921804005-5fdb1e5da881?q=80&w=1600&auto=format&fit=crop",
  ...
  CDG: {
    ...
    hotels: [
      ...
      },
      {
        ...
        reviewCount: 2600,
        image:
          "https://images.unsplash.com/photo-1549144511-f099e773c147?q=80&w=1600&auto=format&fit=crop",
